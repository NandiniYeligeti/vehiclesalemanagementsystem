...
export const updateVehicleModelAction = (id: string, data: any, onSuccess?: () => void, onError?: (err: any) => void) => ({
...
export const deleteVehicleModelAction = (id: string, onSuccess?: () => void, onError?: (err: any) => void) => ({
